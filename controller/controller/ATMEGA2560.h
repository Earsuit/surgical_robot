...
#define AIN1_PIN_2 PA1      //D23, need to set as an output, connect to A2 in
...
#define AIN1_PIN_3 PA2      //D24, need to set as an output, connect to A2 in
#define C1_COUNT_PIN_3 PD2  //D19, Phase B, use INT2
#define C2_READ_PIN_3 PC4   //Phase A, D33, need to set as an input
//Motor 4
#define PWM_PIN_4 PB5       //D11, OC1A, connect to A1 in
#define AIN1_PIN_4 PA3      //D25, need to set as an output, connect to A2 in
